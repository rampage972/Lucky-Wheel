...
export default class Wheel extends React.Component {
    ...
    componentDidMount = () => {
        if (this.props.selectItem) this.setState({ selectItem: this.props.selectItem })
    }
    ...
    selectItem() {
        ...
        this.setState({ selectedItem: null }, () => setTimeout(() => {
            ...
            let selectedItem
            let min = 1
            let max = this.props.listUser.length
            selectedItem = Math.round(Math.random() * (max - min) + min)
    ...
    handleGetReward = () => {
        ...
        var spinWheel = new TimelineMax();
         indicator.to(active, .13, {rotation: -50, transformOrigin:"65% 36%", ease:Power1.easeOut})
        ...
        spinWheel.to(wheel, 5, {
            rotation: deg, transformOrigin: "50% 50%", ease: Power4.easeOut, onUpdate: (
                function (e) {
                    console.log(e)
                    currentRotation = 0    //_gsTransform: current position of the wheel
                ...
                <div class="container">
                    <div class="row buttons">
                        <div class="col-xs-6 col-lg-6 col-md-6">
                            <button onClick={() => this.handleGetReward()} id="btnPlay" class="btn btn-primary">Start</button>
                        </div>
                        <div class="col-xs-6 col-lg-6 col-md-6">
